...
$.fn.cube = function(options) {
    ...
    const CUBE_COLORS = [GREEN,BLUE,YELLOW,WHITE,RED,ORANGE,GREY];
    ...
    _ref.powerSaveMode = true;
    _ref.workToDo = true;

    _ref.workRequired = function() {
        if (!_ref.powerSaveMode) return;
    ...
    _ref.workCompleted = function() {
        if (!_ref.powerSaveMode) return;

        console.log('---------- Work completed.');
        setTimeout(function() {
            console.log('---------- Turning off renderer.', _ref.uid);
    ...
    // TODO: review the render refresh cycle, need to look at pausing when the move stack is empty.

    _ref.renderRequired = true;
    ...
    function constructor() {
        ...
        // const vpX = -60 * 300 / _ref.width();
        // const vpY = -80 * 300 / _ref.height();
        // const vpW = _ref.width()*1.4;
        // const vpH = _ref.height()*1.4;

        const vpX = -20;
        const vpY = -30;
        const vpW = _ref.width();
        const vpH = _ref.height();


        _renderer.setSize(_ref.width(), _ref.height());
        //_renderer.setViewport(vpX,vpY,vpW, vpH);
